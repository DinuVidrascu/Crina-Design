...
// Variants pentru gallery motion mai rapid, de sus în jos
...
const ProjectPage = () => {
  ...
  return (
    <>
      {/* Loading overlay */}
      {pageLoading && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-[#1f1f1f]">
      ...
      <div className="bg-[#1f1f1f] text-white min-h-screen">
        ...
        <div className="p-8 max-w-6xl mx-auto">
          <Link to="/proiecte" className="inline-flex items-center gap-2 text-sm font-medium text-white bg-[#2b2b2b] border border-gray-300 hover:bg-[#444444] rounded-xl px-6 py-3 shadow-lg transform hover:scale-105 transition">
        ...
        <div className="p-8 max-w-6xl mx-auto">
          ...
          {/* Animated gallery */}
          <motion.div variants={galleryVariants} initial="hidden" animate={pageLoading ? 'hidden' : 'visible'}>
            <Masonry
